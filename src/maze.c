...
static const char HELP_TEXT[] = ""
                                ...
                                "  --lpath\n"
                                "  --shortest\n";
static const char ALGORITHM_NOT_PROVIDED_ERROR_TEXT[] = "Only 1 flag can be provided. See --help for more information.\n";
static const char TO_MANY_MAZES_ERROR_TEXT[] = "Only 1 maze file path can be provided. See --help for more information.\n";
